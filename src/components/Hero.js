...
import pfp from "../pp5.jpg";
import logo from "../loggo.png"; // Import your logo here
import {
  Bars3Icon,
  XMarkIcon,
  SunIcon,
...
export default function Hero() {
      ...
      <header className="fixed bg-base-300 shadow-2xl shadow-neutral inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <Link
                key={item.id} // Add key to prevent React warning
                to={item.id}
                spy={true}
                smooth={true}
                offset={50}
                duration={500}
                className="text-lg font-semibold leading-6 cursor-pointer relative w-fit block after:block after:content-[''] after:absolute after:h-[3px] after:bg-current after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-left"
              >
                {item.name}
              </Link>
            ))}
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <p>
                  Passionate about crafting responsive and engaging web applications with
                   a focus on usability and design. 
                  Enthusiastic about learning new technologies and delivering impactful solutions.
                  </p>
                </div>
                <div className="mt-10 flex items-center justify-center gap-x-4">
  {/* GitHub Link */}
  <a
    href="https://github.com/Bemni-21"
    target="_blank"
  ...
  {/* LinkedIn Link */}
  <a
    href="https://www.linkedin.com/in/beimnet-dawit-143ab6297/"
    target="_blank"
    rel="noopener noreferrer"
    className="btn btn-outline btn-square"
  >
